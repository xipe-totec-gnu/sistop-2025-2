...
[página principal del repositorio](https://github.com/unamfi/sistop-2025-2).
...
<https://github.com/unamfi/sistop-2025-2>; lo primero que debes hacer
...
`unamfi/sistop-2025-2`, ahora lo mostrará con tu nombre de usuario.
...
(https://github.com/fulano/sistop-2025-2/ substituyendo, claro,
...
branch is 1 commit ahead of unamfi/sistop-2025-2*.
...
## 8. Configura tu copia local para _seguir_ al repositorio raiz
...
remota*. Por ejemplo, podrías llamarla de forma que me describa, `prof`:
    ...
    $ git remote add --track main prof https://github.com/unamfi/sistop-2025-2
