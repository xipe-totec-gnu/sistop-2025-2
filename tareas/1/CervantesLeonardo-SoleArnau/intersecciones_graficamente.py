...
# Mutex para mostrar como se ve la interseccion y los diferentes hilos no impriman de manera simultanea
...
def view_intersection():
    ...
    print("    | | |")
    print("  __| | |__")
    print("  __ {} {} __".format(intersection_squares[0], intersection_squares[1]))
